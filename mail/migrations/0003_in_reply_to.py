...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mail.in_reply_to'
        # (to signature: django.db.models.fields.related.OneToOneField(to=orm['mail.Mail'], unique=True, null=True, blank=True))
        db.alter_column('mail_mail', 'in_reply_to_id', orm['mail.mail:in_reply_to'])
        
        # Creating unique_together for [in_reply_to] on Mail.
        db.create_unique('mail_mail', ['in_reply_to_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [in_reply_to] on Mail.
        db.delete_unique('mail_mail', ['in_reply_to_id'])
        
        # Changing field 'Mail.in_reply_to'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['mail.Mail'], null=True, blank=True))
        db.alter_column('mail_mail', 'in_reply_to_id', orm['mail.mail:in_reply_to'])
